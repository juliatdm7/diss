...
```{r, fig.align='center'}
ggplot(environment, aes(x=sites, y=new_site_occ)) +
  geom_point() +
  theme_bw() +
...
```{r, fig.align='center'}
ggplot(environment, aes(x=elevation, y=new_site_occ)) +
  geom_point() +
  theme_bw() +
...
#### c) Number of oak trees

```{r, fig.align='center'}
ggplot(environment, aes(x=sites, y=TOTAL_oak)) +
  geom_point() +
  theme_bw() +
...
ggplot(environment, aes(x=TOTAL_oak, y=new_site_occ)) +
  geom_point() +
  theme_bw() +
